...
def gen_robot_list():
    robot1 = get_robot_dic('p3at', 'robot1', 0, 0, 0.03, 0, 0, 0)
    robot2 = get_robot_dic('p3at', 'robot2', 15, 84, 0.03, 0, 0, 0)
    robot3 = get_robot_dic('p3at', 'robot3', -15, 160, 0.03, 0, 0, 0)
...
def generate_launch_description():
    ...
    ld = spawn_world('RoboCup2019-semi-1.model')
