...
def gen_robot_list():
    robot1 = get_robot_dic('p3at', 'robot1', 134, -45, 0.03, 0, 0, 0)
    robot2 = get_robot_dic('p3at', 'robot2', 132, -45, 0.03, 0, 0, 0)
    robot3 = get_robot_dic('p3at', 'robot3', 100, -60, 0.03, 0, 0, 0)
    robot4 = get_robot_dic('p3at', 'robot4', 100, -57, 0.01, 0, 0, 0)
...
def generate_launch_description():
    ...
    ld = spawn_world('Robocup2019_pre2-2.model')
