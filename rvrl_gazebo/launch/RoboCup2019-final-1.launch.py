...
def gen_robot_list():
    robot1 = get_robot_dic('p3at', 'robot1', 126, -52, 0.03, 0, 0, 0)
    robot2 = get_robot_dic('p3at', 'robot2', 124, -52, 0.03, 0, 0, 0)
    robot3 = get_robot_dic('p3at', 'robot3', 126, -52, 0.03, 0, 0, 0)
    robot4 = get_robot_dic('p3at', 'robot4', -9, -86, 0.01, 0, 0, 0)
    robot5 = get_robot_dic('p3at', 'robot5', -10, 84, 0.01, 0, 0, 0)
...
def generate_launch_description():
    ...
    ld = spawn_world('RoboCup2019-final-1.model')
