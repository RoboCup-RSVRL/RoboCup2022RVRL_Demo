...
def gen_robot_list():
    # table is at (4.88346, 2.92577)
    robot1 = get_robot_dic('p3at', 'robot1', -2.88346, +3.5577, 0.01, 0, 0, -1.57079)
    #robot1 = get_robot_dic('p3at', 'robot1', -2.88346, +3.5577, 0.01, 0, 0, -3.14159)
...
def generate_launch_description():
    ...
    ld = spawn_world('house_world.model')
